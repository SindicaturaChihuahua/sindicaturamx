CREATE TABLE dm_s_transparencia (
...
CREATE TABLE dm_s_transparencia_archivos (
...
CREATE TABLE dm_s_transparencia_categorias (
...
CREATE TABLE dm_s_transparencia_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'transparencia', 'Transparencia', 'Transparencia', '1.0', 'editor', 'eye', 'Editor', '30000');
