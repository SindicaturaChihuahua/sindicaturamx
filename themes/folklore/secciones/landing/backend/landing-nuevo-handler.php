		...
		if($obj && $obj['tipo']==$tipo){
			...
			if($obj['autor_id'] == $user->uid || $user->hasRole("EditorEnJefe")){
				if($accion=="editar"){
					...
					$updateData['bloque1']=array();
					$updateFields=array('autor_id', 'titulo', 'descripcion', 'bloque1', 'btntxt1', 'btntxt2', 'btntxt3', 'formato', 'slug', 'seo_titulo', 'seo_descripcion', 'visibilidad', 'creado', 'modificado', 'status', 'extra');
					...
					if(!isset($_POST['titulo']) || !validaGeneral($_POST['titulo'],3,280)){
						...
						$updateData['bloque1']['titulo'] = $_POST['bloque1_titulo'];
						$updateData['bloque1']['texto'] = $_POST['bloque1_texto'];

						// $updateData['bloque2']['titulo1'] = $_POST['bloque2_titulo1'];
						// $updateData['bloque2']['texto1'] = $_POST['bloque2_texto1'];


						$updateData['bloque1']=json_encode($updateData['bloque1']);

						$updateData['btntxt1'] = $_POST['btntxt1'];
						$updateData['btntxt2'] = $_POST['btntxt2'];
						$updateData['btntxt3'] = $_POST['btntxt3'];
					...
					if(!isset($_POST['seo_descripcion']) || $_POST['seo_descripcion']==""){
						$_POST['seo_descripcion']=truncar_cadena(strip_tags($_POST['bloque1_texto']),160," ","");
					}
