            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-12">
						...
						<div class="form-group">
                            <label class="control-label">Título (Home)</label>
                            <input type="text" class="form-control" name="categoria_tagline" value="<?=cleanOutput($object['categoria_tagline']);?>">
                        </div>
						<div class="form-group">
                            <label class="control-label">Título (Interior)</label>
                            <input type="text" class="form-control" name="categoria_tagline2" value="<?=cleanOutput($object['categoria_tagline2']);?>">
                        </div>
						<div class="form-group">
                            <label class="control-label">Extracto (Home)</label>
                            <input type="text" class="form-control" name="categoria_extracto" value="<?=cleanOutput($object['categoria_extracto']);?>">
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <textarea name="categoria_beneficios" class="aneditor" autocomplete="off"><?=$object['categoria_beneficios'];?></textarea>
                        </div>
                        <div class="form-group">
