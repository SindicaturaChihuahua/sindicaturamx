...
if(logeado() && $user->exists && $user->hasRole("EditorEnJefe")){
	...
	if(isset($_REQUEST['id']) && is_numeric($_REQUEST['id'])){
		...
		if($object){
			if($accion=="editar"){
				$updateData=array();
				$updateFields=array('categoria_nombre', 'categoria_descripcion', 'categoria_tagline', 'categoria_tagline2', 'categoria_extracto', 'categoria_beneficios', 'categoria_slug', 'status');
				...
				if(!isset($_POST['categoria_nombre']) || !validaGeneral($_POST['categoria_nombre'],2,48)){
					...
					$updateData['categoria_descripcion'] = $_POST['categoria_descripcion'];
					$updateData['categoria_tagline'] = $_POST['categoria_tagline'];
					$updateData['categoria_tagline2'] = $_POST['categoria_tagline2'];
					$updateData['categoria_extracto'] = $_POST['categoria_extracto'];
					$updateData['categoria_beneficios'] = $_POST['categoria_beneficios'];
