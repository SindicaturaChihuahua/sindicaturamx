		...
		if($obj && $obj['tipo']==$tipo){
			...
			if($obj['autor_id'] == $user->uid || $user->hasRole("EditorEnJefe")){
				if($accion=="editar"){
					...
					$updateFields=array('autor_id', 'titulo', 'tagline', 'url', 'slug', 'seo_titulo', 'seo_descripcion', 'visibilidad', 'creado', 'modificado', 'status', 'extra');
					...
					if(!isset($_POST['seo_descripcion']) || $_POST['seo_descripcion']==""){
						$_POST['seo_descripcion']=truncar_cadena(strip_tags($_POST['titulo']),160," ","");
					}
