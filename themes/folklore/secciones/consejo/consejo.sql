...
CREATE TABLE dm_s_consejo_archivos (
...
CREATE TABLE dm_s_consejo_categorias (
...
CREATE TABLE dm_s_consejo_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'consejo', 'Consejo Consultivo', 'Consejo Consultivo', '1.0', 'editor', 'sitemap', 'Editor', '30000');
