...
if(logeado() && $user->exists && $user->hasRole($controlador->permiso)){
	...
	if(isset($_GET['beta']) && $_GET['beta']=='editar' && isset($_GET['delta']) && $obj = $controlador->getPost($_GET['delta'], $_GET['gama'])){
		$cHeaderData['titulo'] = 'Editar miembro';
		$url->addBreadcrumb(array('nombre' => 'Editar miembro', 'link' => 's/'.$controlador->name.'/editar/'.$obj['tipo'].'/'.$obj['post_id']));
		...
		$cHeaderData['titulo'] = 'Nuevo miembro';
		$url->addBreadcrumb(array('nombre' => 'Nuevo miembro', 'link' => 's/'.$controlador->name.'/nuevo/'.$obj['tipo']));
	}else{
            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-12">
						...
						<div class="form-group">
                            <label class="control-label">Asociación/Empresa</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><?=URL;?>consejo/</span>
