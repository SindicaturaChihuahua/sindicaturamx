<?php
class back_consejo extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
		$this->backclass = "back_consejo";
		$this->frontclass = "front_consejo";
        $this->name = "consejo";
        $this->order = '1';
        $this->version = '1.1.0';
		$this->tab = 'editor';
		...
		$this->single_files = array(
			...
			'icono' => array(
				'required' => array("jpg","jpge","jpeg","gif","png"),
				'maxfilesize' => '10',
				'info_btn' => '<span class="fa fa-file-image-o"></span> &nbsp;Logo Asociación',
				'info' => 'Selecciona el logotipo de la asociación a la que pertenece el miembro',
				'tipoarchivo' => 'image',
				'extra' => false
			),
			'archivo' => array(
