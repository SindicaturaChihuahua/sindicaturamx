CREATE TABLE dm_s_transparenciaslider (
...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'transparenciaslider', 'Slider Transparencia', 'Carrusel', '1.0', 'nosotros', 'certificate', 'Editor', '30000');
