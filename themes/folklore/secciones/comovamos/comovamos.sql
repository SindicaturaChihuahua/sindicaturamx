CREATE TABLE dm_s_comovamos (
  ...
  textos text NOT NULL, /*nombre1, texto1, nombre2, texto2*/
  graficas text NOT NULL, /* id, tipo, nombre, descripcion */
  tipo varchar(30) NOT NULL DEFAULT 'indicador',
...
CREATE TABLE dm_s_comovamos_archivos (
...
CREATE TABLE dm_s_comovamos_categorias (
...
CREATE TABLE dm_s_comovamos_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

CREATE TABLE dm_s_comovamos_valores (
...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'comovamos', '¿Cómo vamos?', '¿Cómo vamos?', '1.0', 'editor', 'line-chart', 'Editor', '30000');
