...
CREATE TABLE dm_s_acalendario_archivos (
...
CREATE TABLE dm_s_acalendario_categorias (
...
CREATE TABLE dm_s_acalendario_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'acalendario', 'Calendario de Regidores', 'Calendario de Regidores', '1.0', 'ayuntamiento', 'calendar', 'Editor', '30000');
