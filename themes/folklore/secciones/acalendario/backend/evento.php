...
if(logeado() && $user->exists && $user->hasRole($controlador->permiso)){
	...
	if(isset($_GET['beta']) && $_GET['beta']=='editar' && isset($_GET['delta']) && $obj = $controlador->getPost($_GET['delta'], $_GET['gama'])){
		$cHeaderData['titulo'] = 'Editar evento';
		$url->addBreadcrumb(array('nombre' => 'Editar evento', 'link' => 's/'.$controlador->name.'/editar/'.$obj['tipo'].'/'.$obj['post_id']));
		...
		$cHeaderData['titulo'] = 'Nuevo evento';
		$url->addBreadcrumb(array('nombre' => 'Nuevo evento', 'link' => 's/'.$controlador->name.'/nuevo/'.$obj['tipo']));
	}else{
	...
	$proSQL="SELECT * FROM ".DB_PREFIX."s_acomisiones WHERE status = 'publicado' ORDER BY titulo ASC";
	...
	echo '<div class="box">';
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sesion_lugar" value="<?=cleanOutput($obj['sesion_lugar']);?>">
                        </div>
						<div class="form-group">
                        	<label class="control-label">Día y hora del evento:</label>
						...
						<div class="form-group">
							...
							<?php
							if($obj['destacado']){
								echo '<input type="checkbox" name="destacado" value="1" checked>';
							}else{
								echo '<input type="checkbox" name="destacado" value="1">';
							}
							?>
                        </div>
						*/ ?>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							...
							foreach($comisiones as $com){
								$selected = '';
								if($com["post_id"] == $obj["categoria_id"]){
									$selected = ' selected';
								}
					...
					<div class="col-sm-5">
						<div class="form-group">
                            <label class="control-label">Enviar correo</label>
							<select name="correoenviado" class="form-control">
								<option value="0">No</option>
								<option value="1">Si, enviar a todos</option>
							</select>
                        </div>
					</div>
					<?php
        ...
        <div class="row object-image-con">
        	<div class="col-sm-3">
            	<h4>Recursos</h4>
                <p>Selecciona los distintos recursos asignados a este evento.</p>
            </div>
            <div class="col-sm-9">
		...
		*/
        ...
        <div class="row">
        	<div class="col-sm-3">
            	<h4>Visibilidad</h4>
                <p>Controla si el evento estará visible en el sitio.</p>
            </div>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
        ...
        <div class="row informacion-comprimida" id="motores-de-busqueda-row">
        	<div class="col-sm-3">
                ...
                <p>Establece el título de tu página, la meta descripción y la URL amigable. Esto ayuda a definir como el evento se muestra en los motores de búsqueda.</p>
            </div>
            <div class="col-sm-9">
				<div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><?=URL;?>calendario-de-regidores/</span>
