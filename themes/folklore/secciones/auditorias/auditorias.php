<?php
class back_auditorias extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
		$this->backclass = "back_auditorias";
		$this->frontclass = "front_auditorias";
	...
	public function call($accion,$gama=false,$delta=false) {
		if($accion=="lista"){
			...
			if($gama=="auditoria"){
				return array(
					"file" => "backend/auditoria-nuevo-handler",
					"ajax" => true
				);
			}
