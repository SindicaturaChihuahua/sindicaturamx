...
CREATE TABLE dm_s_auditorias_archivos (
...
CREATE TABLE dm_s_auditorias_categorias (
...
CREATE TABLE dm_s_auditorias_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'auditorias', 'Auditorías', 'Auditorías', '1.0', 'editor', 'search', 'Editor', '30000');
