...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'aliados', 'Aliados', 'Aliados', '1.0', 'editor', 'handshake-o', 'Editor', '30000');
