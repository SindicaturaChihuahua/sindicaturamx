CREATE TABLE dm_s_slidesecciones (
...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'slidesecciones', 'Carrusel de Secciones', 'Carrusel de Secciones', '1.0', 'editor', 'sticky-note', 'Editor', '30000');
