<?php
class back_convocatorias extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
		$this->backclass = "back_convocatorias";
		$this->frontclass = "front_convocatorias";
	...
	public function call($accion,$gama=false,$delta=false) {
		if($accion=="lista"){
			...
			if($gama=="convocatoria"){
				return array(
					"file" => "backend/convocatoria",
					"css" => array(
			...
			if($gama=="convocatoria"){
				return array(
					"file" => "backend/convocatoria-nuevo-handler",
					"ajax" => true
				);
			}
