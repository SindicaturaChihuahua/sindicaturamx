CREATE TABLE dm_s_convocatorias (
  ...
  etapa varchar(110) NOT NULL DEFAULT '',
  descripcion text NOT NULL,
  video varchar(240) NOT NULL DEFAULT '',
  tipo varchar(30) NOT NULL DEFAULT 'convocatoria',
...
CREATE TABLE dm_s_convocatorias_archivos (
...
CREATE TABLE dm_s_convocatorias_categorias (
...
CREATE TABLE dm_s_convocatorias_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'convocatorias', 'Convocatorias', 'Convocatorias', '1.0', 'contraloria', 'search', 'Editor', '30000');
