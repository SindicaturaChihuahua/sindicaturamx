...
if(logeado() && $user->exists && $user->hasRole($controlador->permiso)){
	...
	$cHeaderData=array(
		'titulo' => 'Miembros del Ayuntamiento',
		'icono' => 'users',
		'opciones' => array(
			array(
				'nombre' => 'Agregar Destacado',
				'link' => $controlador->static_urls['nuevo'].'/destacado',
				'icono' => 'user-plus'
			),
			array(
				'nombre' => 'Agregar Miembro',
				'link' => $controlador->static_urls['nuevo'].'/miembro',
				'icono' => 'user-plus'
			),
			// array(
			// 	'nombre' => 'Categorías',
