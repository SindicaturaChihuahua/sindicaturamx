...
CREATE TABLE dm_s_amiembros_archivos (
...
CREATE TABLE dm_s_amiembros_categorias (
...
CREATE TABLE dm_s_amiembros_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

CREATE TABLE dm_s_amiembros_comisiones (
  comision_id bigint(20) UNSIGNED NOT NULL auto_increment,
  miembro_id bigint(20) UNSIGNED NOT NULL,
  comision_asignada bigint(20) UNSIGNED NOT NULL,
  comision_nombre varchar(200) NOT NULL DEFAULT '',
  comision_puesto varchar(200) NOT NULL DEFAULT '',
  orden smallint(5) UNSIGNED NOT NULL DEFAULT '50000',
  visibilidad varchar(14) NOT NULL DEFAULT 'publico',
  status varchar(14) NOT NULL DEFAULT 'revision',
  modificado datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'amiembros', 'Miembros', 'Miembros', '1.0', 'ayuntamiento', 'users', 'Editor', '30000');
