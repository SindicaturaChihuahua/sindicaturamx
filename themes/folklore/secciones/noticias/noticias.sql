...
CREATE TABLE dm_s_noticias_archivos (
...
CREATE TABLE dm_s_noticias_categorias (
...
CREATE TABLE dm_s_noticias_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'noticias', 'Noticias', 'Noticias', '1.0', 'editor', 'newspaper-o', 'Editor', '30000');
