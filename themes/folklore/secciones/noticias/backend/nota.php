...
if(logeado() && $user->exists && $user->hasRole($controlador->permiso)){
	...
	if(isset($_GET['beta']) && $_GET['beta']=='editar' && isset($_GET['delta']) && $obj = $controlador->getPost($_GET['delta'], $_GET['gama'])){
		$cHeaderData['titulo'] = 'Editar nota';
		$url->addBreadcrumb(array('nombre' => 'Editar nota', 'link' => 's/'.$controlador->name.'/editar/'.$obj['tipo'].'/'.$obj['post_id']));
		...
		$cHeaderData['titulo'] = 'Nueva nota';
		$url->addBreadcrumb(array('nombre' => 'Nueva nota', 'link' => 's/'.$controlador->name.'/nuevo/'.$obj['tipo']));
	}else{
	...
	echo '<div class="box">';
        ...
        <div class="row">
        	<div class="col-sm-3">
            	<h4>Visibilidad</h4>
                <p>Controla si la nota estará visible en el sitio.</p>
            </div>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><?=URL;?>noticias/</span>
