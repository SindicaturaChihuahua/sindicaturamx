	...
	if(isset($_REQUEST['id']) && is_numeric($_REQUEST['id'])){
		...
		if($blog_post){
			if($accion=="editar"){
				...
				$updateFields=array('titulo', 'descripcion', 'btn_link', 'btn_link2', 'marca', 'formato', 'slug', 'visibilidad', 'creado', 'modificado', 'status');
				...
				if(!isset($_POST['titulo']) || !validaGeneral($_POST['titulo'],3,280)){
					...
					$updateData['formato'] = $_POST['formato'];
					...
					$updateData['btn_link2'] = $_POST['btn_link2'];
