CREATE TABLE dm_s_evaluaciones (
  ...
  cimtra varchar(50) NOT NULL default '',
  imco varchar(50) NOT NULL default '',
  descripcion TEXT NOT NULL default '',
  btn_texto varchar(300) NOT NULL default 'Más información',
  btn_link varchar(300) NOT NULL default '',
  btn_texto2 varchar(300) NOT NULL default 'Más información',
  btn_link2 varchar(300) NOT NULL default '',
...
INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'evaluaciones', 'Evaluaciones externas', '', '1.0', 'indicadores', 'bar-chart', 'Editor', '30000');
