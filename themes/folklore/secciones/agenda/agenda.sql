...
CREATE TABLE dm_s_agenda_archivos (
...
CREATE TABLE dm_s_agenda_categorias (
...
CREATE TABLE dm_s_agenda_relation (
  post_id bigint(20) UNSIGNED NOT NULL,
  categoria_id bigint(20) UNSIGNED NOT NULL
);

INSERT INTO dm_secciones (seccion_id, nombre, displaynombre, description, version, tab, icon, permiso, orden) VALUES (NULL, 'agenda', 'Agenda', 'Agenda', '1.0', 'editor', 'calendar', 'Editor', '30000');
