<?php
class front_info_para_todas_las_personas extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
        $this->name = "info-para-todas-las-personas";
        $this->order = '1';
        $this->version = '1.0.0';
		$this->tab = 'editor';
		$this->displayName = 'info_para_todas_las_personas';
		$this->description = 'Portada principal del sistema';
		$this->icon = 'edit';
		$this->databaseprefix = 's_info_para_todas_las_personas';
		$this->permiso = '';
