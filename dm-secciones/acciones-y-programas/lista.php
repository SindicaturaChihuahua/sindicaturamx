...
$bodys->set('titulo', "Acciones y Programas");
$bodys->setMeta('title', "Acciones y Programas");
        ...
        <div class="wrap wrapmed">
			<div class="margin-wrap">
				<div class="contraloria-top">
					<h1>Acciones y Programas</h1>
					<p>En esta sección podrás encontrar los avances de los programas y acciones del Municipio de Chihuahua de acuerdo con lo establecido en el Plan Municipal de Desarrollo 2018 – 2021. Además, podrás conocer todas las convocatorias que tiene el Gobierno Municipal en materia de apoyos, transferencias y subsidios.</p>
				</div>
				<div class="contraloria-top">
					<img src="<?=URLIMAGES;?>contraloria.png" alt="Acciones y Programas">
				</div>
			</div>
        </div>
		<div class="wrap wrapmed">
