<?php
class front_acciones_y_programas extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
        $this->name = "acciones-y-programas";
        $this->order = '1';
        $this->version = '1.0.0';
		$this->tab = 'editor';
		$this->displayName = 'acciones_y_programas';
		$this->description = 'Portada principal del sistema';
		$this->icon = 'edit';
		$this->databaseprefix = 's_acciones_y_programas';
		$this->permiso = '';
