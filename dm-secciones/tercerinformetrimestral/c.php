<?php
class front_tercerinformetrimestral extends Seccion {

	function __construct($db)
	{
		$this->db = $db;
        $this->name = "tercerinformetrimestral";
        $this->order = '1';
        $this->version = '1.0.0';
		$this->tab = 'editor';
		$this->displayName = 'tercerinformetrimestral';
		$this->description = 'Portada principal del sistema';
		$this->icon = 'edit';
		$this->databaseprefix = 's_tercero';
		$this->permiso = '';
