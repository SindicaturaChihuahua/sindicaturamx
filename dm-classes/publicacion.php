...
class Publicacion {
	...
	{
		$this->db = $db;
		$this->databaseprefix = "s_publicaciones";
	}

	public function init(){
		$this->data['folderpath'] = URLCARGAS.'publicaciones/obj'.$this->data['post_id'].'/';
	...
	public function printNota(){
		echo '<div class="noticia-box">
			<a href="'.$this->url.'" title="'.$this->titulo.'" class="noticia-img" style="background-image:url('.$this->data["cover_image_big"].');" target="_blank"></a>
			<div class="noticia-txt">
				<span class="noticia-categoria">'.$this->tagline.'</span>
				<a href="'.$this->url.'" title="'.$this->titulo.'" target="_blank"><h3>'.$this->titulo_truncado.'</h3></a>
				<p>'.$this->extracto.'</p>
			</div>
		</div>';
	}
