...
class TransparenciaItem {
	...
	public function init(){
		$this->data['folderpath'] = URLCARGAS.'transparencia/obj'.$this->data['post_id'].'/';
		...
		$this->url = URL.'transparencia/'.$this->slug;
	...
	public function getInformacion($slug){
	...
	public function printInformacion(){
		...
		echo '<tr>
			...
			<td class="td-info-fecha" data-label="Fecha: ">'.$this->fecha.'</td>
			<td class="td-info-dwn" data-label="Descargas: ">'.$dictamenes.'</td>
		</tr>';
	}
